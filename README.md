...
```docker run --name cups-airprint --restart unless-stopped --net host cups-airprint:latest```
...
docker exec -it cups-airprint /usr/sbin/lpadmin -p samsung-m283x -E \
